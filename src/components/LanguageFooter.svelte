<script>
  ...
  import all_languages from '../../locales/legalcode.json';

	const languages = all_languages.filter(x => x.lang !== $locale);
</script>
<p class="shaded"><a id="languages"></a>{@html $_('language_footer.text')}
