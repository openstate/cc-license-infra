        ...
        <div class="cc-footer-links"><!---->
          <div class="menu-footer-links-container"><!---->
            <ul id="menu-footer-links" class="menu"><!---->
              <li id="menu-item-48794" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48794"><a href="https://creativecommons.org/about/contact/">{@html $_('header.contact')}</a></li>
